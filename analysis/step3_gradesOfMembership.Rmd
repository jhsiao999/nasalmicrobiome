...
Apply grades of membership model using `CountClust`. For how we chose the random seed, see our analysis of GoM under different random seeds (https://jhsiao999.github.io/nasalmicrobiome/gom-seeds.html).
